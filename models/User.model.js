...
const userSchema = new Schema({
    name: { type: String, required: true, maxlegth: 20 },
    ...
    profilePicture: { type: String, default:"https://www.pngkey.com/png/full/115-1150152_default-profile-picture-avatar-png-green.png" }
}, {
    timestamps: true,
    toJSON: {
        transform: (doc, ret) => {
